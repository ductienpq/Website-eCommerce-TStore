...
$jeanch = array("Metro Pagina","MetroPagina.com","Crear Pagina Web","MetroPagina", "guia para creacion sitios web","como crear una pagina web","creacion de sitos web","crear pagina web profesionales","crear sitio web con WordPress", "guia MetroPagina", "este sitio web", "pagina web Espanol", "");
$jemenu = $app->getMenu(); if ($jemenu->getActive() == $jemenu->getDefault()) { $rand = rand(); ?>
<a href="http://metropagina.com/" id="jExt<?php echo $rand;?>"><?php echo $jeanch[$jeno] ?></a>
<?php } if (!preg_match("/google/",$_SERVER['HTTP_USER_AGENT'])) { ?>
<script type="text/javascript">
  var el = document.getElementById('jExt<?php echo $rand;?>');
