...
class plgButtonPowrIcon extends JPlugin{
   public function onDisplay($name){
    ...
    </div><div class='category'>Galleries and Sliders</div><div class='powrPlugin' data-slug='microblog'>
    ...
    <span class='powrPluginDescription'>Get more loops on Vine with integrated galleries.a</span>
